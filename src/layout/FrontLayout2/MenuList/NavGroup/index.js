...
const NavGroup = ({ item, lastItem, remItems, lastItemId }) => {
    ...
    const itemCollapse = <NavCollapse key={currentItem.id} menu={currentItem.children} level={1} parentId={currentItem.id} />;
        ...
        <>
            {layout === LAYOUT_CONST.VERTICAL_LAYOUT || (layout === LAYOUT_CONST.HORIZONTAL_LAYOUT && matchDownMd) ? (
                <>
                    ...
                    <NavCollapse key={currentItem.id} menu={currentItem} parentId={currentItem.id} level={1} />
                    {/* group divider */}
