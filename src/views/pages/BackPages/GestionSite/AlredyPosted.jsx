...
import { Close, Delete, Archive, Done, Edit, MoreVert, Publish, Visibility } from '@mui/icons-material';
...
const Publication = () => {
    ...
    useEffect(() => {
        let config = {
            ...
            url: siteUrlApi(`contents-back/posted`),
            headers: {
                'id-user-back': user.id
            },
            params: {
    ...
    const handleVoir = () => {
        navigate('/backinterface/gestion-site/publication');
    };
    if (load) {
        return (
        ...
        return (
            <>
                ...
                <Box sx={{ width: '100%' }}>
                    ...
                    >
                        <Typography variant="h2">{`Les contenus publier`}</Typography>
                        <Button onClick={handleVoir} variant="outlined" color="primary">
                            Voir les contenus non publiés
                        </Button>
                    </Grid>
        ...
        <>
            ...
            >
                ...
                <MenuItem key="delete" component={Button} onClick={props.openDelete} sx={{ color: 'text.secondary' }} fullWidth>
                    ...
                    <ListItemText primary="Retirer" style={alignStart} />
                </MenuItem>
            </Menu>
        </>
    );
