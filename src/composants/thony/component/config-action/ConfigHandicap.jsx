...
export default function ConfigHandicap(props) {
    const idHandicap = props.id;
    const nameHandicap = props.name;
            ...
            >
                <Box sx={{ ...style, width: 400 }}>
                    ...
                    <p id="parent-modal-description">
                        Vous êtes sur pour efffacer <span style={{ fontWeight: 'bold' }}>{nameHandicap}</span>
                    </p>
                    <Stack spacing={3} direction={'row'} justifyContent={'flex-end'}>
