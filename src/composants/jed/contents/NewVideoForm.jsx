...
const NewVideoForm = () => {
    ...
    const submitFormData = async (values) => {
        ...
        let config = {
            ...
            url: siteUrlApi('contents-back/video'),
            headers: {
                'id-user-back': idUser,
                'Content-Type': 'multipart/form-data'
            },
                    ...
                    <Box margin="normal" display="flex" flexDirection="column" alignItems="center">
                        <input
                            ...
                            onChange={(event) => {
                                ...
                                // You can also use the FileReader API to preview the video
                                const reader = new FileReader();
                                reader.onload = (e) => {
                                    formik.setFieldValue('videoPreview', e.target.result);
                                };
                                reader.readAsDataURL(file);
                            }}
                        />
                        <label htmlFor="video-upload">
                            <Button variant="contained" color="primary" component="span" sx={{ margin: '20px' }}>
                                Parcourir Une Video
                            </Button>
                        </label>
                        ...
                        {formik.values.videoPreview && (
                            ...
                            <video width="80%" height="80%" controls src={formik.values.videoPreview} alt="Video Preview" />
                        )}
                    </Box>
                )}
